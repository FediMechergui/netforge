...
describe('catalog index', () => {
  it('validates with zero issues at CATALOG_STAGE, and the inputs also validate at P1', () => {
    // §9.2 "P1 W5 (catalog)": the catalog is derived for P1 from this wave on.
    ...
    expect(table).toMatchInlineSnapshot(`
      {
        ...
        "dcswitch.nfn9k-32": "caps=switching,routing,layer3-switch | proc=hdlc,eth-switch,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=switched×32 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1],Loopback | up=true",
        "dcswitch.nfn9k-48": "caps=switching,routing,layer3-switch | proc=hdlc,eth-switch,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=switched×54 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1],Loopback | up=true",
        "firewall.nfasa5506": "caps=routing,firewall | proc=hdlc,arp,ipv4,icmpv4,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=routed×8 console | cli=nfos/nfos/1/console+vty | gui=physical | owners= | host= | virtual=Loopback | up=false",
        "firewall.nfngfw1120": "caps=routing,firewall | proc=hdlc,arp,ipv4,icmpv4,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=routed×12 console | cli=nfos/nfos/1/console+vty | gui=physical | owners= | host= | virtual=Loopback | up=false",
        ...
        "ids.nfsensor": "caps=host | proc=arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=mgmt routed×2 | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.command-prompt,desktop.web-browser | owners= | host=GigabitEthernet0/0 | virtual= | up=true",
        "iot.nfcamera": "caps=host,poe-powered | proc=arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=routed | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.command-prompt,desktop.web-browser | owners= | host=FastEthernet0 | virtual= | up=true",
        "iot.nfgateway": "caps=host,wifi-client | proc=wlan-client,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=routed wireless-client | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.wifi,desktop.command-prompt,desktop.web-browser | owners= | host=GigabitEthernet0,Wlan0 | virtual= | up=true",
        "iot.nfplug": "caps=host,wifi-client | proc=wlan-client,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=wireless-client | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.wifi,desktop.command-prompt,desktop.web-browser | owners= | host=Wlan0 | virtual= | up=true",
        ...
        "ipphone.nfphone": "caps=host,switching,poe-powered | proc=eth-switch,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=switched×2 | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.command-prompt,desktop.web-browser | owners=svi:eth-switch | host=Vlan1 | virtual=Vlan[1] | up=true",
        "laptop.nflaptop": "caps=host,wifi-client | proc=wlan-client,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=routed wireless-client console | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.wifi,desktop.command-prompt,desktop.web-browser | owners= | host=GigabitEthernet0,Wlan0 | virtual= | up=true",
        "mlswitch.nfc3650-24": "caps=switching,routing,layer3-switch | proc=hdlc,eth-switch,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=switched×28 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1],Loopback | up=true",
        "mlswitch.nfc9300-48": "caps=switching,routing,layer3-switch,poe-source | proc=hdlc,eth-switch,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=switched×56 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1],Loopback | up=true",
        ...
        "pc.nfpc": "caps=host | proc=arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=routed | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.command-prompt,desktop.web-browser | owners= | host=GigabitEthernet0 | virtual= | up=true",
        ...
        "router.nf1941": "caps=routing,modular | proc=hdlc,arp,ipv4,icmpv4,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=routed×2 console×2 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan,Loopback | up=false",
        "router.nf2911": "caps=routing | proc=hdlc,arp,ipv4,icmpv4,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=routed×2 wan×2 console | cli=nfos/nfos/1/console+vty | gui=physical | owners= | host= | virtual=Loopback | up=false",
        "router.nf4331": "caps=routing,modular | proc=hdlc,arp,ipv4,icmpv4,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=routed×3 console×2 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan,Loopback | up=false",
        "router.nf4451": "caps=routing,modular | proc=hdlc,arp,ipv4,icmpv4,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=routed×6 console | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan,Loopback | up=false",
        "router.nfgeneric": "caps=routing,modular | proc=hdlc,arp,ipv4,icmpv4,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=console | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan,Loopback | up=false",
        "server.nfrack": "caps=host,server | proc=arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-client,http-server,traceroute | roles=routed×6 | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.command-prompt,desktop.web-browser,services | owners= | host=GigabitEthernet0,GigabitEthernet1,GigabitEthernet2,GigabitEthernet3,TenGigabitEthernet0,TenGigabitEthernet1 | virtual= | up=true",
        "server.nfserver": "caps=host,server | proc=arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-client,http-server,traceroute | roles=routed×2 | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.command-prompt,desktop.web-browser,services | owners= | host=GigabitEthernet0,GigabitEthernet1 | virtual= | up=true",
        "switch.nfc2960": "caps=switching | proc=eth-switch,arp,ipv4,icmpv4,host | roles=switched×26 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1] | up=true",
        "switch.nfc2960-24pg": "caps=switching,poe-source | proc=eth-switch,arp,ipv4,icmpv4,host | roles=switched×28 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1] | up=true",
        "switch.nfc2960-48": "caps=switching | proc=eth-switch,arp,ipv4,icmpv4,host | roles=switched×50 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1] | up=true",
        "switch.nfc2960-8": "caps=switching | proc=eth-switch,arp,ipv4,icmpv4,host | roles=switched×9 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1] | up=true",
        "switch.nfc9200-48": "caps=switching,poe-source | proc=eth-switch,arp,ipv4,icmpv4,host | roles=switched×52 | cli=nfos/nfos/1/console+vty | gui=physical | owners=svi:eth-switch | host= | virtual=Vlan[1] | up=true",
        ...
        "wlc.nfwlc3504": "caps=host | proc=arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dns-client,http-client,traceroute | roles=routed×4 console | cli=host/host/15/console | gui=physical,desktop.ip-config,desktop.command-prompt,desktop.web-browser | owners= | host=GigabitEthernet0/1,GigabitEthernet0/2,GigabitEthernet0/3,GigabitEthernet0/4 | virtual= | up=true",
        "wrouter.nfhome": "caps=switching,routing,wifi-ap,nat-gateway,dhcp-server | proc=wlan-ap,hdlc,eth-switch,arp,ipv4,icmpv4,host,ipv6,nd,icmpv6,udp,tcp,dhcp-client,dhcp-server,dns-client,dns-server,http-server,traceroute | roles=wan switched×4 wireless-bss×2 | cli=none/nfos/1/ | gui=physical,home-router.setup | owners=svi:eth-switch | host= | virtual=Vlan[1] | up=true",
